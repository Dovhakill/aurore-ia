...
class Settings:
    ...
    def validate(cls):
        missing = []
        # On ajoute la nouvelle clé à la vérification
        for attr in ["GNEWS_API_KEY", "GEMINI_API_KEY", "GH_TOKEN", "UNSPLASH_ACCESS_KEY", "GH_SITE_REPO", "BLOBS_PROXY_URL", "AURORE_BLOBS_TOKEN"]:
